...
export const museums: Museum[] = [
  {
    ...
    headline: "雪国の地下にある、不思議な美術館",
    body: "ゴールデンウィークに行ってみたい美術館のひとつが、青森県立美術館。地面に半分埋まったような独特の建築がまず目を引き、中に入ると奈良美智の巨大な「あおもり犬」が出迎えてくれます。\nシャガールの大作など見ごたえのある作品も多く、美術館自体の空間が面白いと評判です。三内丸山遺跡のすぐ隣にあるので、一緒に回れるのも魅力のひとつ。青森まで足を伸ばす価値がありそうな、気になるスポットです。",
    image: aomoriImage,
  ...
  },
  {
    ...
    headline: "アートと本が共存する\n特別なキャンパス。",
    body: "ゴールデンウィークに行ってみたい美術館2つ目が、東京・小平にある武蔵野美術大学の美術館・図書館。建築家・藤森照信が手がけた図書館の内部は、床から天井まで本棚が続く圧巻の空間で、それだけでも一見の価値がありそうです。美術系大学の施設だけあってコレクションの質も高く、デザインや工芸など幅広いジャンルの作品に触れられます。\n学生たちが行き交うキャンパスの雰囲気も心地よく、アートと日常が自然に混ざり合った独特の空気感が魅力です。ゴールデンウィーク中は企画展も開催されていることが多いので、事前にチェックしてから行くのがよさそうです。",
  ...
  },
  {
    ...
    body: "最後に紹介するのが、香川県・直島にある地中美術館。建物のほとんどが地面の中に埋まっているのに、自然光だけで空間が照らされるという、訪れるまで想像しにくい不思議な場所です。\n安藤忠雄が設計したコンクリートの空間に、モネの「睡蓮」やジェームズ・タレルの光の作品など、ほんの数点の作品だけが展示されています。作品の少なさが逆に贅沢で、ひとつひとつをじっくり体験できると評判です。直島へは船でしか行けませんが、その非日常感も含めて「旅」として楽しめそうな、特別感のある美術館です。",
    image: chichuImage,
